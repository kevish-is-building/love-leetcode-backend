  ...
  try {
    ...
    res
      ...
      .json(
        new ApiResponse(
          200,
          "All submissions fetched successfully for user",
          submissions,
        ),
      );
  } catch (error) {
    res
      ...
      .json(
        new ApiError(
          500,
          "Failed to fetch user's submissions for this problem",
        ),
      );
  }
};
  ...
  try {
    ...
    res
      ...
      .json(
        new ApiResponse(
          200,
          "All submissions count fetched successfully",
          submissions,
        ),
      );
  } catch (error) {
    res
      ...
      .json(
        new ApiError(
          500,
          "Failed to fetch count of submissions for this problem",
        ),
      );
  }
};
